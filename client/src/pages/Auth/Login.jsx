    ...
    <>
      ...
      <Grid>
        <Paper elevation={20} style={loginStyle}>
          <Grid style={{ textAlign: 'center' }} marginBottom={8}>
          ...
          <form onSubmit={handleSubmit}>
            <TextField
              ...
              InputLabelProps={{
                style: {
                  marginLeft: "10px",
                  color: emailFocused ? "#6C3483" : labelColor,
                },
              }}
            ...
            <TextField
              ...
              label={
                <div className="label">
                  <NoEncryptionIcon style={{ width: "25px", height: "20px" }} />{" "}
                  Password
                </div>
              }
              sx={input}
              ...
              InputLabelProps={{
                style: {
                  marginLeft: "10px",
                  color: passwordFocused ? "#6C3483" : labelColor,
                },
              }}
