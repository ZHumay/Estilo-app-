...
<h2 style={{transform:"translateX(70px)",color:"rgb(66, 64, 64)",fontSize:"29px",width:"300px"}}> Product overview</h2 >

</div>
<div className="overview">
      <Link className="overview_link"  to="/allproducts">All products</Link>

       <Link className="overview_link"   to="/women">Women</Link>
       <Link className="overview_link"  to="/men">Men</Link>
        <button className="filterbtn"> <FilterListIcon style={{height:"20px",width:"20px",marginBottom:"-5px",marginRight:"6px"}}/><span style={{color:"rgb(70, 70, 70)",fontSize:"15px"}} >Filter</span></button>
      </div>
      ...
      {data?.data.map((product) => (
        <Grid key={product.id} item xs={6} sm={6} md={4} lg={3}>
          {!isAdded(product.id) && (
            <Card sx={{ height: '100%',maxWidth: '300px' }} style={{ margin: 'auto' }}>
              <FavoriteBorderIcon style={{color:"#A569BD",marginLeft:"10px",marginTop:"5px"}}/>
              <CardMedia
                component="img"
                image={product.image}
                style={{
