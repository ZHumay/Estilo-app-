...
const { create_post, get_post, all_posts, delete_post, update_post, like_dislike, incrementOrderedCount, decrementOrderedCount  } = require("../controllers/postController");
